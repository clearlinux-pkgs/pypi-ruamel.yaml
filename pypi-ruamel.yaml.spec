...
Source0  : https://files.pythonhosted.org/packages/27/fc/73edf1269fab4ae08ada602f4bf17b0a0428b3bf10574c2ea7331d73f87d/ruamel.yaml-0.17.33.tar.gz
...
%prep
%setup -q -n ruamel.yaml-0.17.33
cd %{_builddir}/ruamel.yaml-0.17.33
pushd ..
cp -a ruamel.yaml-0.17.33 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1695915997
