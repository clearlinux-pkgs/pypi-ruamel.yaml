...
Version  : 0.17.30
Release  : 74
URL      : https://files.pythonhosted.org/packages/65/86/477e7b26bce5c7dcd70e016e47bb2b8a64e2dca78cf7320839ebffd016ec/ruamel.yaml-0.17.30.tar.gz
Source0  : https://files.pythonhosted.org/packages/65/86/477e7b26bce5c7dcd70e016e47bb2b8a64e2dca78cf7320839ebffd016ec/ruamel.yaml-0.17.30.tar.gz
...
%prep
%setup -q -n ruamel.yaml-0.17.30
cd %{_builddir}/ruamel.yaml-0.17.30
pushd ..
cp -a ruamel.yaml-0.17.30 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1685461570
