...
Source0  : https://files.pythonhosted.org/packages/d1/d6/eb2833ccba5ea36f8f4de4bcfa0d1a91eb618f832d430b70e3086821f251/ruamel.yaml-0.17.40.tar.gz
...
%prep
%setup -q -n ruamel.yaml-0.17.40
cd %{_builddir}/ruamel.yaml-0.17.40
pushd ..
cp -a ruamel.yaml-0.17.40 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697825509
