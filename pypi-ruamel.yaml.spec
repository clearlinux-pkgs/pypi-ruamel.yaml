...
Source0  : https://files.pythonhosted.org/packages/82/43/fa976e03a4a9ae406904489119cd7dd4509752ca692b2e0a19491ca1782c/ruamel.yaml-0.18.5.tar.gz
...
%prep
%setup -q -n ruamel.yaml-0.18.5
cd %{_builddir}/ruamel.yaml-0.18.5
pushd ..
cp -a ruamel.yaml-0.18.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699022715
